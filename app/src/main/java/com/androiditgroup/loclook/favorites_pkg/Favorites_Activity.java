 ...
 */
public class Favorites_Activity extends     ActionBarActivity
                        ...
                        if (drawerItem instanceof Nameable) {
                            ...
                            if(itemIdentifier > 0 && itemIdentifier != 2) {
                                ...
                                switch(drawerItem.getIdentifier()) {
                                    ...
                                    case 1:
                                            intent = new Intent(Favorites_Activity.this, Tape_Activity.class);
                                            break;
                                    case 3:
                                            intent = new Intent(Favorites_Activity.this, Notifications_Activity.class);
                                            break;
                                    case 4:
                                            intent = new Intent(Favorites_Activity.this, Badges_Activity.class);
                                            break;
                                    case 5:
                                            intent = new Intent(Favorites_Activity.this, RegionMap_Activity.class);
                                            break;
                                }
